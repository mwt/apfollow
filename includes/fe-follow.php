...
<?php } ?>
                <div class="card-header d-flex">
                    ...
                    <div class="mx-3">
                        ...
                        <span class="d-block text-light text-opacity-50">@<?= $local_user ?>@<?= $local_instance ?></span>
                    </div>
                </div>
            </a>
            <div class="card-body">
                <form novalidate="novalidate" action="" enctype="multipart/form-data" accept-charset="UTF-8" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="remote_follow[acct]" class="form-control bg-dark text-light border-secondary" placeholder="Enter your username@domain you want to follow from" autocapitalize="none" autocorrect="off">
                    </div>
                    <button type="submit" class="btn btn-primary w-100 text-uppercase">Proceed to follow</button>
                </form>
            </div>
            <div class="card-footer">
                <p class="card-text text-light text-opacity-50 text-center lh-sm">
